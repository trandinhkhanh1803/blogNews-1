    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <h2><i class="fa fa-gears bg-orange"></i> Cộng đồng <small class="hidden-xs-down hidden-sm-down">Nulla
                                    ...
                                    <div class="blog-box">
                                        ...
                                        <div class="blog-meta big-meta">
                                            ...
                                            <p>Aenean interdum arcu blandit, vehicula magna non, placerat elit.
                                                Mauris
                                                et pharetratortor. Suspendissea sodales urna. In at augue elit.
                                                Vivamus
                                                enim nibh.</p>
