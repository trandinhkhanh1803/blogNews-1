                                        ...
                                        <div class="mega-menu-content clearfix">
                                            <div class="tab">
                                                ...
                                                <button class="tablinks" onclick="openCategory(event, 'cat04')">Tin
                                                    tức</button>
                                                <button class="tablinks" onclick="openCategory(event, 'cat05')">Phong
                                                    cách sống</button>
                                            </div>
                                                            ...
                                                            <div class="blog-box">
                                                                ...
                                                                <div class="blog-meta">
                                                                    <h4><a href="single.php" title="">Relax with
                                                                            the unique warmth of candle flavor</a></h4>
                                                                </div>
                                                                <!-- end meta -->
                                                            </div>
                                                            <!-- end blog-box -->
                                                            ...
                                                            <div class="blog-box">
                                                                ...
                                                                <div class="blog-meta">
                                                                    <h4><a href="single.php" title="">Which color
                                                                            is the most suitable color for you?</a></h4>
                                                                </div>
                                                                <!-- end meta -->
                                                            </div>
                                                            <!-- end blog-box -->
                                                            ...
                                                            <div class="blog-box">
                                                                ...
                                                                <div class="blog-meta">
                                                                    <h4><a href="single.php" title="">One of the
                                                                            most beautiful ports in the world</a></h4>
                                                                </div>
                                                                <!-- end meta -->
                                                            </div>
                                                            <!-- end blog-box -->
                                                            ...
                                                            <div class="blog-box">
                                                                ...
                                                                <div class="blog-meta">
                                                                    <h4><a href="single.php" title="">The world's
                                                                            finest and clean meat restaurants</a></h4>
                                                                </div>
                                                                <!-- end meta -->
                                                            </div>
                                                            <!-- end blog-box -->
