        ...
        <div class="masonry-blog clearfix">
            <div class="first-slot">
                <div class="masonry-box post-media">
                    <img src="images/posts/featured-lg.jpg" class="img-fluid">
                    <div class="shadoweffect">
                        <div class="shadow-desc">
                            <div class="blog-meta">
                                <span class="bg-orange"><a href="tech-category-01.html" title="">Sự kiện</a></span>
            ...
            <div class="second-slot">
                <div class="post-tabs rounded bordered">
                    <ul class="nav nav-tabs nav-pills" id="postTab" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <button aria-controls="recent" aria-selected="false" class="nav-link"
                                data-bs-target="#recent" data-bs-toggle="tab" id="recent-tab" role="tab" type="button">
                                Gần đây
                            </button>
                        </li>
                ...
                <div class="page-wrapper">
                    ...
                    <div class="blog-list clearfix">
                        <div class="blog-box row">
                            ...
                            <div class="blog-meta big-meta col-md-8">
                                <h4><a href="single.php" title="">Top 10 phone applications and 2021 mobile
                                        design awards</a></h4>
                        ...
                        <div class="blog-box row">
                            ...
                            <div class="blog-meta big-meta col-md-8">
                                <h4><a href="single.php" title="">A device you can use both headphones and
                                        usb</a></h4>
                                <p>Aenean interdum arcu blandit, vehicula magna non, placerat elit. Mauris et
                                    pharetratortor. Suspendissea sodales urna. In at augue elit. Vivamus enim nibh,
                                    maximus ac felis nec, maximus tempor odio.</p>
                        ...
                        <div class="blog-box row">
                            ...
                            <div class="blog-meta big-meta col-md-8">
                                <h4><a href="single.php" title="">Two brand new laptop models from ABC
                                        computer</a></h4>
                                <p>Aenean interdum arcu blandit, vehicula magna non, placerat elit. Mauris et
                                    pharetratortor. Suspendissea sodales urna. In at augue elit. Vivamus enim nibh,
                                    maximus ac felis nec, maximus tempor odio.</p>
                        ...
                        <div class="blog-box row">
                            ...
                            <div class="blog-meta big-meta col-md-8">
                                <h4><a href="single.php" title="">Applications for taking photos of nature in
                        ...
                        <div class="blog-box row">
                            ...
                            <div class="blog-meta big-meta col-md-8">
                                <h4><a href="single.php" title="">Say hello to colored strap models in smart
                                        hours</a></h4>
                                <p>Aenean interdum arcu blandit, vehicula magna non, placerat elit. Mauris et
                                    pharetratortor. Suspendissea sodales urna. In at augue elit. Vivamus enim nibh,
                                    maximus ac felis nec, maximus tempor odio.</p>
                        ...
                        <div class="blog-box row">
                            ...
                            <div class="blog-meta big-meta col-md-8">
                                <h4><a href="single.php" title="">How about evaluating your old mobile phones
                        ...
                        <div class="blog-box row">
                            ...
                            <div class="blog-meta big-meta col-md-8">
                                <h4><a href="single.php" title="">Drinking coffee at the computer rests the
                                        spirit</a></h4>
                                <p>Aenean interdum arcu blandit, vehicula magna non, placerat elit. Mauris et
                                    pharetratortor. Suspendissea sodales urna. In at augue elit. Vivamus enim nibh,
                                    maximus ac felis nec, maximus tempor odio.</p>
                        ...
                        <div class="blog-box row">
                            ...
                            <div class="blog-meta big-meta col-md-8">
                                <h4><a href="single.php" title="">If you are considering buying a new safe for
                        ...
                        <div class="blog-box row">
                            ...
                            <div class="blog-meta big-meta col-md-8">
                                <h4><a href="single.php" title="">Enjoy a summer with a colorful headset</a>
                                </h4>
                                <p>Aenean interdum arcu blandit, vehicula magna non, placerat elit. Mauris et
                                    pharetratortor. Suspendissea sodales urna. In at augue elit. Vivamus enim nibh,
                                    maximus ac felis nec, maximus tempor odio.</p>
                        ...
                        <div class="blog-box row">
                            ...
                            <div class="blog-meta big-meta col-md-8">
                                <h4><a href="single.php" title="">Google has developed a brand new algorithm.
